...
export class HttpClient {
  ...
  post(path, payload = {}, options = {}) {
    ...
    if (typeof payload === 'string') {
      ...
      // K6's http.post automatically encodes objects as form data when Content-Type is set
      // But we need to ensure it's passed correctly - K6 handles this automatically
      finalPayload = payload;
    }
